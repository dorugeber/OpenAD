...
/* $Header: /m_home/m_utkej/Argonne/cvs2svn/cvs/Open64/osprey1.0/libF77/shiftc_b.c,v 1.1.1.1 2002-05-22 20:09:13 dsystem Exp $ */
/*	  All Rights Reserved  	*/
...
int8 shftc_b(int8 *m,int8 *k,int8 *ic)
{
	...
	left = (*k > 0);
	k2 = left ? *k : -*k;
	if (k2 == 0 || k2 > NBB || k2 > *ic || *ic < 1 || *ic > NBB)
		return(*m);
	d = (*ic - k2);
