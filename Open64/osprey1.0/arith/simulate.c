...
/* 
 * Solaris porting
 * The ported mfef90 causes "illegal instruction" error when running on Fortran
 * files containing floating-point number assignment. This error happens during
 * the following ar_sim("defgu2sd") call. 
 */
