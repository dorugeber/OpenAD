...
#include "xaifBooster/algorithms/BasicBlockPreaccumulationTape/driver/buildStamp.hpp"
...
int main(int argc,char** argv) { 
  ...
  xaifBoosterBasicBlockPreaccumulationTape::AlgFactoryManager* theFManager_p=
    dynamic_cast<xaifBoosterBasicBlockPreaccumulationTape::AlgFactoryManager*>(xaifBoosterBasicBlockPreaccumulationTape::AlgFactoryManager::instance());
  theFManager_p->init();
  xaifBoosterBasicBlockPreaccumulationTape::AlgConfig* algConfig_p=theFManager_p->makeAlgConfig(argc,argv,buildStamp);
  try { 
    algConfig_p->config();
