...
int main(int argc,char** argv) { 
  ...
  xaifBoosterPushPop::AlgFactoryManager* theFManager_p=
    dynamic_cast<xaifBoosterPushPop::AlgFactoryManager*>(xaifBoosterPushPop::AlgFactoryManager::instance());
  theFManager_p->init();
  xaifBoosterPushPop::AlgConfig* algConfig_p=theFManager_p->makeAlgConfig(argc,argv,buildStamp);
  try { 
    algConfig_p->config();
