...
C$OPENAD XXX Template ad_template.f
     ...
     > ) +(__value__(PRIMR5) ** 2))
      ...
      OpenAD_lin_24 = __value__(PRIML1)
     ...
     > PRIML2)))
      ...
      OpenAD_lin_30 = __value__(PRIMR1)
     ...
     > ) * OpenAD_lin_36))
      ...
      CALL sax(OpenAD_lin_3, __deriv__(NRM3), __deriv__(OpenAD_prp_0))
      CALL saxpy(OpenAD_lin_1, __deriv__(NRM1), __deriv__(OpenAD_prp_0)
     > )
      CALL saxpy(OpenAD_lin_2, __deriv__(NRM2), __deriv__(OpenAD_prp_0)
     > )
      CALL sax(OpenAD_acc_12, __deriv__(PRIMR2), __deriv__(OpenAD_prp_1
     > ))
      CALL saxpy(OpenAD_acc_13, __deriv__(PRIML2), __deriv__(
     > OpenAD_prp_1))
      CALL sax(OpenAD_lin_17, __deriv__(PRIML5), __deriv__(OpenAD_prp_2
     > ))
      CALL saxpy(OpenAD_lin_15, __deriv__(PRIML3), __deriv__(
     > OpenAD_prp_2))
      CALL saxpy(OpenAD_lin_16, __deriv__(PRIML4), __deriv__(
     > OpenAD_prp_2))
      CALL sax(OpenAD_lin_20, __deriv__(PRIMR5), __deriv__(OpenAD_prp_3
     > ))
      CALL saxpy(OpenAD_lin_18, __deriv__(PRIMR3), __deriv__(
     > OpenAD_prp_3))
      CALL saxpy(OpenAD_lin_19, __deriv__(PRIMR4), __deriv__(
     > OpenAD_prp_3))
      CALL sax(OpenAD_lin_0, __deriv__(OpenAD_prp_0), __deriv__(NSIZE))
      CALL sax(OpenAD_lin_5, __deriv__(NRM1), __deriv__(NXHAT))
      CALL saxpy(OpenAD_acc_2, __deriv__(NSIZE), __deriv__(NXHAT))
      CALL sax(OpenAD_lin_7, __deriv__(NRM2), __deriv__(NYHAT))
      CALL saxpy(OpenAD_acc_3, __deriv__(NSIZE), __deriv__(NYHAT))
      CALL sax(OpenAD_lin_9, __deriv__(NRM3), __deriv__(NZHAT))
      ...
      CALL saxpy(OpenAD_lin_22, __deriv__(PRIML2), __deriv__(HL))
      ...
      CALL saxpy(OpenAD_lin_28, __deriv__(PRIMR2), __deriv__(HR))
      ...
      CALL sax(OpenAD_lin_35, __deriv__(PRIMR3), __deriv__(UAVE))
      CALL saxpy(OpenAD_acc_11, __deriv__(OpenAD_prp_1), __deriv__(UAVE
     > ))
      CALL saxpy(OpenAD_lin_33, __deriv__(PRIML3), __deriv__(UAVE))
      CALL sax(OpenAD_lin_39, __deriv__(PRIMR4), __deriv__(VAVE))
      CALL saxpy(OpenAD_lin_37, __deriv__(PRIML4), __deriv__(VAVE))
      CALL saxpy(OpenAD_acc_10, __deriv__(OpenAD_prp_1), __deriv__(VAVE
     > ))
      CALL sax(OpenAD_lin_43, __deriv__(PRIMR5), __deriv__(WAVE))
      CALL saxpy(OpenAD_lin_41, __deriv__(PRIML5), __deriv__(WAVE))
      CALL saxpy(OpenAD_acc_9, __deriv__(OpenAD_prp_1), __deriv__(WAVE)
     > )
      CALL sax(OpenAD_lin_51, __deriv__(WAVE), __deriv__(OpenAD_prp_4))
      CALL saxpy(OpenAD_lin_50, __deriv__(VAVE), __deriv__(OpenAD_prp_4
     > ))
      CALL saxpy(OpenAD_lin_49, __deriv__(UAVE), __deriv__(OpenAD_prp_4
     > ))
     ...
     >  __value__(NYHAT) * __value__(UAVE))
      ...
      CALL sax(OpenAD_lin_54, __deriv__(OpenAD_prp_5), __deriv__(CAVE))
      ...
      OpenAD_aux_11 = (__value__(LAMCM) - __value__(ALAMCM))
      __value__(ALAMCM) = (OpenAD_aux_11 * 5.0D-01)
      OpenAD_aux_12 = (__value__(LAMCP) - __value__(ALAMCP))
     ...
     > UTILDE))
      ...
      OpenAD_lin_117 = __value__(NXHAT)
      OpenAD_lin_118 = __value__(CAVE)
      OpenAD_lin_116 = __value__(DR)
     ...
     > VTILDE))
      ...
      OpenAD_lin_127 = __value__(NYHAT)
     ...
     > WTILDE))
      ...
      OpenAD_lin_137 = __value__(NZHAT)
     ...
     > -1_w2f__i8)) * OpenAD_lin_120)
      ...
      OpenAD_acc_44 = (OpenAD_lin_143 *(-5.0D-01) + OpenAD_acc_42 *
     >  5.0D-01)
      ...
      OpenAD_acc_48 = (OpenAD_lin_111 * 5.0D-01 + OpenAD_acc_42 *
     >  5.0D-01)
      ...
      CALL sax(OpenAD_lin_77, __deriv__(PRIML2), __deriv__(RUL))
      CALL saxpy(OpenAD_lin_78, __deriv__(PRIML3), __deriv__(RUL))
      CALL sax(OpenAD_lin_79, __deriv__(PRIML2), __deriv__(RVL))
      CALL saxpy(OpenAD_lin_80, __deriv__(PRIML4), __deriv__(RVL))
      CALL sax(OpenAD_lin_81, __deriv__(PRIML2), __deriv__(RWL))
      CALL saxpy(OpenAD_lin_82, __deriv__(PRIML5), __deriv__(RWL))
      ...
      CALL saxpy(OpenAD_lin_87, __deriv__(PRIMR2), __deriv__(DRU))
      CALL saxpy(OpenAD_lin_88, __deriv__(PRIMR3), __deriv__(DRU))
      CALL set_neg_deriv(__deriv__(DRV), __deriv__(RVL))
      CALL saxpy(OpenAD_lin_89, __deriv__(PRIMR2), __deriv__(DRV))
      CALL saxpy(OpenAD_lin_90, __deriv__(PRIMR4), __deriv__(DRV))
      CALL set_neg_deriv(__deriv__(DRW), __deriv__(RWL))
      CALL saxpy(OpenAD_lin_91, __deriv__(PRIMR2), __deriv__(DRW))
      CALL saxpy(OpenAD_lin_92, __deriv__(PRIMR5), __deriv__(DRW))
      ...
      CALL sax(OpenAD_lin_73, __deriv__(PRIML1), __deriv__(EL))
      CALL saxpy(OpenAD_lin_74, __deriv__(GM1INV), __deriv__(EL))
      CALL saxpy(OpenAD_lin_75, __deriv__(PRIML2), __deriv__(EL))
      CALL saxpy(OpenAD_lin_76, __deriv__(THETAL), __deriv__(EL))
      CALL set_neg_deriv(__deriv__(DE), __deriv__(EL))
      CALL saxpy(OpenAD_lin_83, __deriv__(PRIMR1), __deriv__(DE))
      CALL saxpy(OpenAD_lin_84, __deriv__(GM1INV), __deriv__(DE))
      CALL saxpy(OpenAD_lin_85, __deriv__(PRIMR2), __deriv__(DE))
      CALL saxpy(OpenAD_lin_86, __deriv__(THETAR), __deriv__(DE))
      CALL sax(OpenAD_lin_109, __deriv__(DRW), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_110, __deriv__(NZHAT), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_107, __deriv__(DRV), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_108, __deriv__(NYHAT), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_105, __deriv__(DRU), __deriv__(NDDRU))
      CALL saxpy(OpenAD_lin_106, __deriv__(NXHAT), __deriv__(NDDRU))
      ...
      CALL saxpy(OpenAD_lin_100, __deriv__(DE), __deriv__(OMEGA))
      ...
      CALL sax(OpenAD_lin_119, __deriv__(OMEGA), __deriv__(ALP2))
      ...
      CALL saxpy(OpenAD_lin_113, __deriv__(DRW), __deriv__(ALP2))
      CALL saxpy(OpenAD_lin_114, __deriv__(NYHAT), __deriv__(ALP2))
      CALL saxpy(OpenAD_acc_57, __deriv__(DRV), __deriv__(ALP2))
      CALL saxpy(OpenAD_acc_58, __deriv__(NZHAT), __deriv__(ALP2))
      CALL sax(OpenAD_lin_129, __deriv__(OMEGA), __deriv__(ALP3))
      ...
      CALL saxpy(OpenAD_lin_123, __deriv__(DRU), __deriv__(ALP3))
      CALL saxpy(OpenAD_lin_124, __deriv__(NZHAT), __deriv__(ALP3))
      CALL saxpy(OpenAD_acc_55, __deriv__(DRW), __deriv__(ALP3))
      CALL saxpy(OpenAD_acc_56, __deriv__(NXHAT), __deriv__(ALP3))
      CALL sax(OpenAD_lin_139, __deriv__(OMEGA), __deriv__(ALP4))
      ...
      CALL saxpy(OpenAD_lin_133, __deriv__(DRV), __deriv__(ALP4))
     ...
     >  __value__(CAVE))))
      OpenAD_lin_157 = __value__(NXHAT)
      OpenAD_lin_158 = __value__(ALP2)
      OpenAD_lin_159 = __value__(NYHAT)
     ...
     >  __value__(NYHAT) + __value__(ALP4) * __value__(NZHAT))
      ...
      OpenAD_lin_167 = __value__(CAVE)
      OpenAD_lin_168 = __value__(GM1INV)
      OpenAD_lin_166 = __value__(ALP15P)
      OpenAD_lin_169 = __value__(UHAT)
      OpenAD_lin_170 = __value__(ALP15M)
      OpenAD_lin_171 = __value__(UTILDE)
      OpenAD_lin_172 = __value__(ALP2)
      OpenAD_lin_173 = __value__(VTILDE)
     ...
     >  __value__(ALP4) * __value__(NYHAT))
      ...
      OpenAD_lin_189 = __value__(NYHAT)
     ...
     >  __value__(ALP2) * __value__(NZHAT))
      ...
      OpenAD_lin_196 = __value__(MU)
      OpenAD_lin_197 = __value__(NZHAT)
     ...
     > NZHAT) + __value__(RWL) * __value__(UHATL))
      ...
      OpenAD_acc_98 = (OpenAD_lin_198 * OpenAD_acc_84 + OpenAD_lin_230
     >  * OpenAD_lin_228)
      ...
      OpenAD_acc_102 = (OpenAD_lin_190 * OpenAD_acc_88 + OpenAD_lin_224
     >  * OpenAD_lin_222)
      ...
      OpenAD_acc_106 = (OpenAD_lin_182 * OpenAD_acc_92 + OpenAD_lin_218
     >  * OpenAD_lin_216)
     ...
     >  OpenAD_lin_208)
      ...
      CALL sax(OpenAD_lin_145, __deriv__(ALAMCM), __deriv__(ALP1))
      CALL saxpy(OpenAD_lin_146, __deriv__(OpenAD_prp_12), __deriv__(
     > ALP1))
      CALL sax(OpenAD_lin_147, __deriv__(ALAMU), __deriv__(ALP2))
      CALL saxpy(OpenAD_lin_148, __deriv__(OpenAD_prp_13), __deriv__(
     > ALP2))
      CALL sax(OpenAD_lin_149, __deriv__(ALAMU), __deriv__(ALP3))
      CALL saxpy(OpenAD_lin_150, __deriv__(OpenAD_prp_14), __deriv__(
     > ALP3))
      CALL sax(OpenAD_lin_151, __deriv__(ALAMU), __deriv__(ALP4))
      CALL saxpy(OpenAD_lin_152, __deriv__(OpenAD_prp_15), __deriv__(
     > ALP4))
      CALL sax(OpenAD_lin_153, __deriv__(ALAMCP), __deriv__(ALP5))
     ...
     > ALP5))
      ...
      CALL sax(OpenAD_lin_201, __deriv__(PRIML3), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_202, __deriv__(NXHAT), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_203, __deriv__(PRIML4), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_204, __deriv__(NYHAT), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_205, __deriv__(PRIML5), __deriv__(UHATL))
      CALL saxpy(OpenAD_lin_206, __deriv__(NZHAT), __deriv__(UHATL))
      CALL sax(OpenAD_lin_155, __deriv__(ALP15P), __deriv__(MU))
      CALL saxpy(OpenAD_lin_156, __deriv__(CAVE), __deriv__(MU))
      CALL saxpy(OpenAD_lin_157, __deriv__(ALP2), __deriv__(MU))
      CALL saxpy(OpenAD_lin_158, __deriv__(NXHAT), __deriv__(MU))
      CALL saxpy(OpenAD_lin_159, __deriv__(ALP3), __deriv__(MU))
      CALL saxpy(OpenAD_lin_160, __deriv__(NYHAT), __deriv__(MU))
      CALL saxpy(OpenAD_lin_161, __deriv__(ALP4), __deriv__(MU))
      CALL saxpy(OpenAD_lin_162, __deriv__(NZHAT), __deriv__(MU))
      CALL sax(OpenAD_lin_211, __deriv__(NSIZE), __deriv__(FLUX2))
      CALL saxpy(OpenAD_acc_108, __deriv__(PRIML2), __deriv__(FLUX2))
      CALL saxpy(OpenAD_acc_109, __deriv__(UHATL), __deriv__(FLUX2))
      CALL saxpy(OpenAD_lin_212, __deriv__(MU), __deriv__(FLUX2))
      CALL sax(OpenAD_lin_215, __deriv__(NSIZE), __deriv__(FLUX3))
      ...
      CALL sax(OpenAD_lin_221, __deriv__(NSIZE), __deriv__(FLUX4))
      ...
      CALL sax(OpenAD_lin_227, __deriv__(NSIZE), __deriv__(FLUX5))
      ...
      CALL sax(OpenAD_lin_207, __deriv__(NSIZE), __deriv__(FLUX1))
