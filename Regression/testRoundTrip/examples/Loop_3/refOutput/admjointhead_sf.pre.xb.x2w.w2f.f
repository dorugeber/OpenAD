...
C           $OpenAD$ INLINE Saxpy(subst,subst,subst)
            CALL Saxpy(OpenAD_Symbol_29, __deriv__(Y(OpenAD_Symbol_28))
     > , __deriv__(OpenAD_prp_0))
C           $OpenAD$ INLINE Saxpy(subst,subst,subst)
            CALL Saxpy(OpenAD_Symbol_30, __deriv__(Y(OpenAD_Symbol_28))
     > , __deriv__(X(OpenAD_Symbol_27)))
C           $OpenAD$ INLINE ZeroDeriv(subst)
            CALL ZeroDeriv(__deriv__(Y(OpenAD_Symbol_28)))
...
C         $OpenAD$ INLINE IncDeriv(subst,subst)
          CALL IncDeriv(__deriv__(Y(OpenAD_Symbol_26)), __deriv__(X(
     > OpenAD_Symbol_26)))
C         $OpenAD$ INLINE ZeroDeriv(subst)
...
C       $OpenAD$ INLINE IncDeriv(subst,subst)
        CALL IncDeriv(__deriv__(Y(OpenAD_Symbol_25)), __deriv__(X(
     > OpenAD_Symbol_25)))
C       $OpenAD$ INLINE ZeroDeriv(subst)
        CALL ZeroDeriv(__deriv__(Y(OpenAD_Symbol_25)))
