...
C
      ...
      INTEGER(w2f__i4) OpenAD_Symbol_22
      INTEGER(w2f__i4) OpenAD_Symbol_23
...
C           $OpenAD$ INLINE pop_i_s0(subst)
            CALL pop_i_s0(OpenAD_Symbol_23)
C           $OpenAD$ INLINE pop_s0(subst)
            CALL pop_s0(OpenAD_Symbol_24)
C           $OpenAD$ INLINE pop_s0(subst)
            CALL pop_s0(OpenAD_Symbol_25)
C           $OpenAD$ INLINE Saxpy(subst,subst,subst)
            CALL Saxpy(OpenAD_Symbol_24, __deriv__(Y(OpenAD_Symbol_23))
     > , __deriv__(OpenAD_prp_0))
C           $OpenAD$ INLINE Saxpy(subst,subst,subst)
            CALL Saxpy(OpenAD_Symbol_25, __deriv__(Y(OpenAD_Symbol_23))
     > , __deriv__(X(OpenAD_Symbol_22)))
C           $OpenAD$ INLINE ZeroDeriv(subst)
            CALL ZeroDeriv(__deriv__(Y(OpenAD_Symbol_23)))
...
C       $OpenAD$ INLINE IncDeriv(subst,subst)
        CALL IncDeriv(__deriv__(Y(OpenAD_Symbol_21)), __deriv__(X(
     > OpenAD_Symbol_21)))
C       $OpenAD$ INLINE ZeroDeriv(subst)
